...
public class DepositTest
{
    ...
    private const DepositArea Area = DepositArea.A;
    private const DepositSize Size = DepositSize.Large;
    ...
    public void TestCanAddAvailabilityPeriods()
    {
        // Arrange
        var deposit = new Deposit(Name, Area, Size, ClimateControl, _promotionList);
        var availabilityPeriod = new DateRange.DateRange(DateOnly.FromDateTime(DateTime.Now),
            DateOnly.FromDateTime(DateTime.Now.AddDays(1)));
        // Act
